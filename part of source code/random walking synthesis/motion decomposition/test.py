...
print index
#print featureVector3[index]
firstPrimitive.backprojection(featureVector3[index])
...
##for i in range(len(newMotion)):
##    newMotion[i][3:6] = oldmotion.data[0][3:6]
##motion = MotionSegment(newMotion, fileList1[0], type = 'data')
#motion.display()
##
